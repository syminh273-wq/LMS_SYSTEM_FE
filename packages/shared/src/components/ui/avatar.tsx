...
>(({ className, ...props }, ref) => {
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full aspect-square items-center justify-center rounded-full bg-muted text-sm text-muted-foreground select-none group-data-[size=sm]/avatar:text-xs",
        className
      )}
      {...props}
    />
