  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setWorkspace(ws);
        setPortfolio(pf);
        dispatch(setProfile(me as unknown as Consumer));
      } catch (err) {
        console.error(err);
    ...
    try {
      if (kind === 'avatar') {
        ...
        if (typeof window !== 'undefined') {
          window.dispatchEvent(new CustomEvent('community:profile-updated', { detail: { avatar_url: newUrl } }));
        }
  ...
  return (
    <WorkspaceShell>
      <MeProfileLayout
        ...
        onEditProfile={() => router.push('/consumer/profile/edit')}
