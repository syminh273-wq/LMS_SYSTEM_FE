    ...
    <section className="space-y-3">
      ...
      {!composerOpen && (
        <div className="flex items-center justify-end">
          <button
            ...
            className="inline-flex items-center gap-1.5 px-4 h-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-full text-[13px] font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-900/50 transition-colors"
          >
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-slate-50 dark:bg-slate-900/50 border border-dashed border-slate-200 dark:border-slate-700 rounded-xl">
          ...
          <p className="text-[12.5px] text-slate-500 dark:text-slate-400 mt-1">Nhấn "Tạo bài đăng" để chia sẻ bài đăng đầu tiên.</p>
        </div>
      ) : (
          ...
          {hasMore && (
            <div className="flex justify-center pt-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-5 h-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-full text-[13px] font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:bg-slate-900/50 transition-colors disabled:opacity-60"
              >
