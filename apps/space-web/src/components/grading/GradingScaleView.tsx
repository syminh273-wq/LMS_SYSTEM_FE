  ...
  return (
    <div className="space-y-4">
      <SectionCard
        ...
        subtitle={g('quiz.card_subtitle', 'Mỗi câu có 4 đáp án, học viên chọn 1 đáp án đúng nhất')}
        icon={BookOpen}
      >
        ...
        <ExampleBox label={g('quiz.example_label', 'Ví dụ')}>
          {g('quiz.example_text', 'Quiz 10 câu, điểm tối đa 10. Học viên đúng 8 câu → 8/10 × 10 = 8.0 điểm.')}
        </ExampleBox>
      </SectionCard>
      ...
      >
        ...
        <ExampleBox label={g('exam.example_label', 'Ví dụ')}>
          {g('exam.example_text', 'Exam 20 câu trắc nghiệm, điểm tối đa 10. Học viên đúng 15 câu → 15/20 × 10 = 7.5 điểm.')}
        </ExampleBox>
      </SectionCard>

      <SectionCard
        title={g('xp.card_title', 'Bảng XP (điểm thưởng)')}
        subtitle={g('xp.card_subtitle', 'Mỗi hoạt động trong hệ thống sẽ cộng XP. XP cộng dồn theo thời gian để tính cấp bậc và thứ hạng tổng.')}
        icon={Sparkles}
        iconClassName="bg-violet-500/10 text-violet-600"
      >
