...
export default function GradingScalePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-8 px-4 space-y-6 animate-in fade-in duration-300">
      ...
      <div className="rounded-2xl border border-primary-brand-light bg-primary-brand-light/40 p-4">
        <p className="text-xs font-medium text-foreground leading-relaxed">
          {g('intro', 'Trang này hiển thị các công thức tính điểm và bảng quy đổi XP đang được áp dụng. Giáo viên dùng để tham khảo khi tạo đề; học viên dùng để hiểu cách điểm và XP được tính.')}
        </p>
      ...
      <GradingScaleView showLeaderboard />
    </div>
  );
}
