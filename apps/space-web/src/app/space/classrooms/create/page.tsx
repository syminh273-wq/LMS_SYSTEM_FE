  ...
  return (
    <div className="max-w-2xl mx-auto py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Tạo phòng học mới</h1>
          <p className="text-slate-500 text-sm font-medium">Khởi tạo không gian học tập chuyên nghiệp cho học sinh của bạn</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Card className="border-slate-200 shadow-sm rounded-2xl overflow-hidden">
          ...
          <CardHeader className="pb-4">
            ...
            <CardDescription className="font-medium text-slate-400">Vui lòng kiểm tra kỹ các thông tin trước khi khởi tạo</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[11px] text-slate-400 font-bold px-1 uppercase tracking-tighter">Hệ thống sẽ tự động khóa đăng ký khi đạt giới hạn</p>
            </div>
          </CardContent>
        </Card>
